...
``` typescript
import pkg from 'https://unpkg.com/start-of-week@^3.1.0/edition-deno/deno.ts'
```
...
``` html
<script type="module">
    import pkg from '//cdn.pika.dev/start-of-week/^3.1.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/start-of-week@^3.1.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/start-of-week@3.1.0'
</script>
```
