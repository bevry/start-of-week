...
``` typescript
import pkg from 'https://unpkg.com/start-of-week@^4.5.0/edition-deno/deno.ts'
```
...
``` html
<script type="module">
    import pkg from '//cdn.skypack.dev/start-of-week@^4.5.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/start-of-week@^4.5.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/start-of-week@4.5.0'
</script>
```
