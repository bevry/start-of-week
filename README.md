...
``` typescript
import pkg from 'https://unpkg.com/start-of-week@^2.3.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import pkg from '//cdn.pika.dev/start-of-week/^2.3.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/start-of-week@^2.3.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/start-of-week@2.3.0'
</script>
```
