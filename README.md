...
``` typescript
import pkg from 'https://unpkg.com/start-of-week@^3.8.1/edition-deno/deno.ts'
```
...
``` html
<script type="module">
    import pkg from '//cdn.skypack.dev/start-of-week@^3.8.1'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/start-of-week@^3.8.1'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/start-of-week@3.8.1'
</script>
```
